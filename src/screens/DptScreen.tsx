...
import { useDptAutomation } from '../hooks/useDptAutomation';
...
const DptScreen = () => {
  ...
  const {
    ...
    onMessage,
    onPageLoadFinished
  } = useDptAutomation(excelDataLengkap, webViewRef, addLog);
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <HeaderPanel
        ...
        HeaderTitle={CONFIG.APP_SCREEN[0]}
        onRun={pilotRun}
        onStop={stopRun}
        isRun={isRun}
        onExport={() => exportResults(results,'Hasil_DPT')}
        ...
        <View style={styles.content}>
          <View style={[styles.tabContent, activeTab !== "console" && styles.hidden]}>
            <ConsolePanel 
              ...
              logMsg={logs} 
              fileName={excelName}
              contentFile={`Berisi ${excelDataLengkap.length} Data Nomor DPT`}
              results={results}
